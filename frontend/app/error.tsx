...
// Catches errors in any page and provides a user-friendly fallback
      ...
      <div className="max-w-2xl w-full">
        <div className="bg-white rounded-[16px] p-8 sm:p-12 shadow-[0px_6px_24px_rgba(0,0,0,0.05)] text-center">
          ...
          {process.env.NODE_ENV === 'development' && (
            <div className="bg-red-50 border border-red-200 rounded-[12px] p-4 mb-8 text-left">
              <p className="text-[14px] leading-[24px] font-medium text-red-900 mb-2">
                Error Details (Development Only):
              </p>
              <p className="text-[13px] leading-[20px] text-red-700 font-mono break-all">
                {error.message}
              </p>
              {error.digest && (
                <p className="text-[13px] leading-[20px] text-red-600 mt-2">
          ...
          {/* Support Link */}
          <p className="text-[14px] leading-[24px] text-gray-600 mt-8">
            Need help?{' '}
